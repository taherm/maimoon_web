        ...
        <ul class="list-unstyled menu-categories" id="accordionExample">
            ...
            <li class="menu">
                ...
                <ul class="collapse submenu list-unstyled" id="Categories" data-parent="#accordionExample">
                    <li>
                        <a href="{{route('category_parts',['category'=>'raditor'])}}">Raditor</a>
                    </li>
                    <li>
                        <a href="{{route('category_parts',['category'=>'arm'])}}">Arm</a>
                    </li>
                    <li>
                        <a href="{{route('category_parts',['category'=>'disk'])}}">Disk</a>
                    </li>
                    <li>
            ...
            <li class="menu">
                <a href="#bush" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle">
                    <div class="">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-cpu">
                            <rect x="4" y="4" width="16" height="16" rx="2" ry="2"></rect>
                            <rect x="9" y="9" width="6" height="6"></rect>
                ...
                <ul class="collapse submenu list-unstyled" id="bush" data-parent="#accordionExample">
                    <!-- <li>
                        <a href="{{route('part.index')}}"> All Parts </a>
                    </li> -->
                    <li>
                        <a href="{{route('bush.create')}}"> Add Parts </a>
                    </li>
                    <li>
                        <a href="{{route('category_bush',['category'=>'bush'])}}">Bushes</a>
                    </li>
                    <li>
                        <a href="{{route('category_bush',['category'=>'wheel_bearing'])}}">Wheel Bearings</a>
                    </li>
                </ul>
            </li>
            <li class="menu">
